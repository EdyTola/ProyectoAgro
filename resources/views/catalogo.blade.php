<x-layouts.app :title="__('Catálogo')">
    <div class="p-6 bg-[#FDFDFC] dark:bg-[#0a0a0a] min-h-screen">
        {{-- Nuevo Header para el Catálogo, similar al de la Boleta --}}
        ...
        {{-- Título y subtítulo con estilos de la boleta --}}
        <h1 class="text-center mb-2 font-bold text-4xl text-[#222]">Catálogo de Productos</h1>
        <p class="text-center text-[#888] mb-8 text-lg">Encuentra los mejores productos agropecuarios para tu negocio.</p>

        {{-- Formulario de búsqueda con colores de la paleta --}}
        ...
        <section class="mt-12 mb-12 max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md text-center">
            ...
            <div class="flex justify-center">
                <a href="{{ route('contactos') }}" class="px-6 py-3 border border-[#837227] text-[#837227] rounded-md hover:bg-[#837227] hover:text-white transition duration-300 flex items-center justify-center">
